...
# CONFIG
# ────────────────────────────────────────────────
st.set_page_config(page_title="NEO-SCOUT v17", layout="wide")

HEADERS = {"User-Agent": "Mozilla/5.0"}

# ────────────────────────────────────────────────
# 🌍 USE YOUR FULL SOURCE LIST HERE
# ────────────────────────────────────────────────
ALL_SOURCES = [
    ...
    # 👉 paste full list here (works fine)
]
...
# UI
# ────────────────────────────────────────────────
st.title("⚡ NEO-SCOUT v17")
st.caption("SOCCER NEWS • NEVER EMPTY FEED")

feed = get_feed(st.session_state.source_limit)

# DEBUG (optional)
# st.write("Articles:", len(feed))
